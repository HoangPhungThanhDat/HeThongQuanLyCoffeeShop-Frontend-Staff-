...
export function Sidenav({ brandImg, brandName, routes }) {
  ...
  return (
    ...
    >
      ...
      <div className="m-4 overflow-y-auto h-[calc(100vh-130px)] pr-2 scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-100">
...
Sidenav.defaultProps = {
  ...
  brandName: "NHÂN VIÊN COFFEE SHOP",
};
