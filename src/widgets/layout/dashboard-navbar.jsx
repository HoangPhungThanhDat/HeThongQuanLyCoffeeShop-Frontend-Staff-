...
export function DashboardNavbar() {
  ...
  // ✅ Hàm xử lý logout
  const handleLogout = () => {
    AuthAPI.logout(); // Xóa token
    navigate("/auth/sign-in"); // Chuyển về trang đăng nhập
  };
              ...
              <MenuItem className="flex items-center gap-3">
                ...
                <div>
                  <Typography variant="small" color="blue-gray" className="mb-1 font-normal">
                    <strong>Tin nhắn mới</strong> từ Laur
                  </Typography>
                  <Typography
                    variant="small"
                    color="blue-gray"
                  ...
                  >
                    <ClockIcon className="h-3.5 w-3.5" /> 13 phút trước
                  </Typography>
                </div>
              </MenuItem>
            </MenuList>
